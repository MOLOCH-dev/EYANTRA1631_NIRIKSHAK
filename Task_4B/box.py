...
def control_logic(center_x,center_y,set_x,set_y,nsx,nsy,end):
	...
	box_x = pmap(error_x,-640,640,-center_x-100,center_x+100) if end == True else pmap(error_x,-640,640,-center_x-nsx,center_x+nsx)
	box_y = pmap(error_y,-640,640,-center_y-100,center_y+100) if end == True else pmap(error_y,-640,640,-center_y-nsy,center_y+nsy)
	box_x = box_x/640
	box_y = box_y/640
	Kpx1=1 #3
	Kpx2=1 #6.5 #3.23 5x 4-4ex234,9,600.0015
	Kdx1=0 #40.25 ,150,347,500, 0.005, 0.004,0.006
	Kdx2 = 0 #0.045 3(1),0.01(2) - good response ,0.010, 0.015
	Kpy1=1
	Kpy2=1 #5.5,60,0.0015
	Kix1=0.0 #5
	Kix2 = 0.0 #0.05
	Kdy1=0
	Kdy2 = 0 #30 x35,55-4,347
	Kiy1 =0.0
	Kiy2 = 0.0
	dinputx = pex - error_x
	dinputy = pey - error_y
