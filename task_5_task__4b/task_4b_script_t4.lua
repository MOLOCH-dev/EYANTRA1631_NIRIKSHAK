...
function generateHorizontalWalls()
	...
	--               ADD YOUR CODE HERE
	horiwall={{},{},{},{},{},{},{},{},{},{},{}}
    parent=sim.getObjectHandle("force_sensor_pw_t4_1")
    for j=0,10,1 do
        for i=1,10,1 do	
...
function createMaze()
	...
	--for t_4
	--for coordinate (9,4):
	if(sim.isHandleValid(horiwall[11][5])==1) then
		sim.removeObject(horiwall[11][5])
	end
	--for coordinate (5,9):
	if(sim.isHandleValid(vertiwall[11][6])==1) then
		sim.removeObject(vertiwall[11][6])
	end
...
function groupWalls()
	...
	sim.setObjectName(wallsGroupHandle,'walls_t4_1')
